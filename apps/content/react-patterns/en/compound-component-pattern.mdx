...
The Compound Component pattern is a design pattern that allows you to create components that work together to form a complete UI while maintaining a flexible and expressive API. Like HTML elements (`<select>` and `<option>`, `<table>`, `<tr>`, and `<td>`), compound components share implicit state and handle communication between parent and child components seamlessly. This pattern provides users of your components with an expressive and flexible API for building complex UIs.

### The Problem

When building complex UI components, you often face a trade-off between flexibility and simplicity. Creating a single component with many props leads to a bloated API that's hard to use and maintain. Passing dozens of configuration props becomes unwieldy, and you sacrifice flexibility because users can't easily rearrange or customize the component's internal structure.
...
function AccordionItem({ children, index }: AccordionItemProps) {
  ...
  return (
    <div className={`${isOpen ? 'bg-gray-50' : ''}`}>
      {children}
    </div>
  )
}
      ...
      <Accordion defaultIndex={0}>
        <Accordion.Item index={0}>
          ...
          <Accordion.Content index={0}>
            ...
            you to create components that work together to form a complete UI
        ...
        <Accordion.Item index={1}>
          ...
          <Accordion.Content index={1}>
            Use this pattern when you need to create flexible, composable
            components with complex internal state that need to communicate
            with each other.
          </Accordion.Content>
        </Accordion.Item>
        ...
        <Accordion.Item index={2}>
          ...
          <Accordion.Content index={2}>
            Benefits include better component composition, clearer APIs,
            easier customization, and separation of concerns between
        ...
        <Modal.Body>
          ...
          <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded">
            <p className="text-sm text-yellow-800">
                Warning: This will delete all your projects, files, and settings.
            </p>
          </div>
        </Modal.Body>
...
**Reduced Prop Complexity**: Instead of dozens of configuration props, you have a clean, compositional API.
...
- You need to provide users with flexibility in how they compose and arrange elements
- Components need to share state but you want to avoid prop drilling
- You want to create a more declarative, HTML-like API
- The component has complex internal state that multiple parts need to access
- You're building a component library and want to provide an intuitive API
...
- You don't need flexibility in component composition
