...
<ComponentPreview 
  ...
  component={
    <div className="flex flex-col items-center space-y-2">
      <pre className="p-4 rounded-md bg-slate-100 dark:bg-slate-800">
        <code>npx degit daltonmenezes/opendocs project_name</code>
      </pre>
      <p className="text-sm text-muted-foreground">Use degit to clone the repository</p>
    </div>
  }
