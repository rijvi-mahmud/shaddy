...
| customHandler            | (level, message, data?) => void         | undefined | Custom log handler                       |
...
| ------- | ------------------------------------------------------------------ | ------------------------------------ |
| debug   | (message: string, ...params: any[]) => void                        | Log debug messages                   |
| info    | (message: string, ...params: any[]) => void                        | Log informational messages           |
| warn    | (message: string, ...params: any[]) => void                        | Log warning messages                 |
| error   | (message: string, ...params: any[]) => void                        | Log error messages with stack traces |
| success | (message: string, ...params: any[]) => void                        | Log success messages (colored green) |
| table   | (data: any, columns?: string[]) => void                            | Display data in table format         |
...
| assert  | (condition: boolean, message: string, ...params: any[]) => void    | Conditional logging                  |
| trace   | (message: string, ...params: any[]) => void                        | Log with stack trace                 |
